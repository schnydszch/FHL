...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="marc items">
    <xsl:import href="http://li628-210.members.linode.com/opac-tmpl/bootstrap/en/xslt/MARC21slimUtils.xsl"/>
   ...
   <xsl:if test="$DisplayOPACiconsXSLT!='0'">
        ...
        <!-- Analytics for Songs -->
        <xsl:if test="$leader7='s' and $leader6='j'">
        <span class="results_summary analytics"><span class="label">Songs in this album: </span>
            <a>
            <xsl:choose>
            ...
            <xsl:text>View songs in this album</xsl:text>
            </a>
        </span>
        </xsl:if>
...
<!-- orig analytics
		...
		<xsl:if test="$leader7='s' and $leader6!='j'">
	<!--	<xsl:if test="$leader7='s' and marc:datafield[@tag=942]/marc:subfield[@code='c']='SER'"> -->
        <span class="results_summary analytics"><span class="label">Analytics: </span>
            <a>
            <xsl:choose>
            <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
        ...
        <xsl:if test="$leader7='s'">
        <span class="results_summary set"><span class="label">Analytics: </span>
...
-->
        ...
        <xsl:for-each select="marc:datafield[@tag=583]">
            ...
            <span class="results_summary actionnote">
                ...
                <xsl:otherwise>
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">abcdefgjklnou</xsl:with-param>
                    </xsl:call-template>
                </xsl:otherwise>
                </xsl:choose>
            </span>
		...
		<!--added for Filipinas Heritage Library Ayala Foundation, Inc. -->
...
-->
        ...
        <span class="results_summary"><span class="label">Heading: </span>
            <xsl:for-each select="marc:datafield[@tag=952]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">8</xsl:with-param>
                    </xsl:call-template>
                   </xsl:with-param>
               </xsl:call-template>
                    <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise><xsl:text>; </xsl:text></xsl:otherwise></xsl:choose>
        ...
        <span class="results_summary"><span class="label">General Note(s): <br /></span></span>
  ...
  <span class="results_summary">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    ...
                    <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose>
</span>           
 </xsl:for-each>
...
<xsl:if test="marc:datafield[@tag=518]">
        <span class="results_summary"><span class="label">Date/Location Note: </span>
        ...
        <span class="results_summary"><span class="label">Source: </span>
        ...
        <span class="results_summary"><span class="label">Owner: </span>
		...
		<xsl:if test="marc:datafield[@tag=591]">
        <span class="results_summary"><span class="label">Image type: </span>
		...
		<xsl:if test="marc:datafield[@tag=530]">
        <span class="results_summary"><span class="label">Media format: </span>
            <xsl:for-each select="marc:datafield[@tag=530]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
		...
		<xsl:if test="marc:datafield[@tag=592]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Caption: </span>
					...
					<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Side: </span>
					...
					<xsl:if test="marc:datafield[@tag=592]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Map Type: </span>
                    <xsl:for-each select="marc:datafield[@tag=592]">
                    <xsl:call-template name="subfieldSelect">
					...
					<xsl:if test="marc:datafield[@tag=592]/marc:subfield[@code='f']">
					 <span class="results_summary"><span class="label">AV Type Note: </span>
                    <xsl:for-each select="marc:datafield[@tag=592]">
                    <xsl:call-template name="subfieldSelect">
		...
		<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='b']">
					 <span class="results_summary"><span class="label">Track: </span>
                    <xsl:for-each select="marc:datafield[@tag=593]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='c']">
					 <span class="results_summary"><span class="label">Length: </span>
                    <xsl:for-each select="marc:datafield[@tag=593]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='d']">
					 <span class="results_summary"><span class="label">Premiere performance: </span>
                    <xsl:for-each select="marc:datafield[@tag=593]">
                    <xsl:call-template name="subfieldSelect">
		...
		<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Movie scoring: </span>
                    <xsl:for-each select="marc:datafield[@tag=593]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=593]/marc:subfield[@code='f']">
					 <span class="results_summary"><span class="label">Cultural community: </span>
                    <xsl:for-each select="marc:datafield[@tag=593]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
		...
		<!-- Notes for composer, lyricist, conductors, etc. 
		!-->
		
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Composer: </span>
		...
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='b']">
					 <span class="results_summary"><span class="label">Composer's Write up: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
			...
			<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='c']">
					 <span class="results_summary"><span class="label">Composer's Date of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='d']">
					 <span class="results_summary"><span class="label">Composer's Date of death: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Composer's Place of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='f']">
					 <span class="results_summary"><span class="label">Composer's father's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=594]/marc:subfield[@code='g']">
					 <span class="results_summary"><span class="label">Composer's mother's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=594]">
                    <xsl:call-template name="subfieldSelect">
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Conductor: </span>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='b']">
					 <span class="results_summary"><span class="label">Conductor's Write up: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='c']">
					 <span class="results_summary"><span class="label">Conductor's Date of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='d']">
					 <span class="results_summary"><span class="label">Conductor's Date of death: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Conductor's Place of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='f']">
					 <span class="results_summary"><span class="label">Conductor's father's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=595]/marc:subfield[@code='g']">
					 <span class="results_summary"><span class="label">Conductor's mother's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=595]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">g</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Lyricist: </span>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='b']">
					 <span class="results_summary"><span class="label">Lyricist write up: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='c']">
					 <span class="results_summary"><span class="label">Lyricist Date of Birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='d']">
					 <span class="results_summary"><span class="label">Lyricist Date of Death: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Lyricist Place of Birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='f']">
					 <span class="results_summary"><span class="label">Lyricist Father's Name: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=596]/marc:subfield[@code='g']">
					 <span class="results_summary"><span class="label">Lyricist Mother's Name: </span>
                    <xsl:for-each select="marc:datafield[@tag=596]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">g</xsl:with-param>
                    </xsl:call-template>
					...
					<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='a']">
					 <span class="results_summary"><span class="label">Musical Director: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">a</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='b']">
					 <span class="results_summary"><span class="label">Musical Director's Write up: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
			...
			<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='c']">
					 <span class="results_summary"><span class="label">Musical Director's Date of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='d']">
					 <span class="results_summary"><span class="label">Musical Director's Date of death: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='e']">
					 <span class="results_summary"><span class="label">Musical Director's Place of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='f']">
				    <span class="results_summary"><span class="label">Musical Director's Father's Name: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=597]/marc:subfield[@code='g']">
				    <span class="results_summary"><span class="label">Musical Director's Mother's Name: </span>
                    <xsl:for-each select="marc:datafield[@tag=597]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">g</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='a']">
				    <span class="results_summary"><span class="label">Performer: </span>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='b']">
				    <span class="results_summary"><span class="label">Performer's Write up: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">b</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='c']">
				    <span class="results_summary"><span class="label">Performer's Date of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='d']">
				    <span class="results_summary"><span class="label">Performer's Date of death: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='e']">
				    <span class="results_summary"><span class="label">Performer's Place of birth: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">e</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='f']">
				    <span class="results_summary"><span class="label">Performer's father's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">f</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=598]/marc:subfield[@code='g']">
				    <span class="results_summary"><span class="label">Performer's mother's name: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">g</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=592]/marc:subfield[@code='c']">
				    <span class="results_summary"><span class="label">Old accession number: </span>
                    <xsl:for-each select="marc:datafield[@tag=598]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">c</xsl:with-param>
                    </xsl:call-template>
		...
		<xsl:if test="marc:datafield[@tag=583]">
        <span class="results_summary"><span class="label">Status: </span>
            <xsl:for-each select="marc:datafield[@tag=583]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
		...
		<xsl:if test="marc:datafield[@tag=592]/marc:subfield[@code='d']">
				    <span class="results_summary"><span class="label">Availability of album cover: </span>
                    <xsl:for-each select="marc:datafield[@tag=592]">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">d</xsl:with-param>
                    </xsl:call-template>
        ...
        <span class="results_summary"><span class="label">Genre/s: </span>
        ...
        <span class="results_summary"><span class="label">Form/s: </span>
		...
		<xsl:if test="marc:datafield[@tag=693]">
        <span class="results_summary"><span class="label">Style: </span>
            <xsl:for-each select="marc:datafield[@tag=693]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">a</xsl:with-param>
		...
		<xsl:if test="marc:datafield[@tag=694]">
        <span class="results_summary"><span class="label">Historical Period/s: </span>
            <xsl:for-each select="marc:datafield[@tag=694]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">a</xsl:with-param>
		...
		<xsl:if test="marc:datafield[@tag=695]">
        <span class="results_summary"><span class="label">Mode/s: </span>
            <xsl:for-each select="marc:datafield[@tag=695]">
                <xsl:call-template name="chopPunctuation">
                  <xsl:with-param name="chopString">
                    <xsl:call-template name="subfieldSelect">
                        <xsl:with-param name="codes">a</xsl:with-param>
